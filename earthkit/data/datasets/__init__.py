...
# from earthkit.data.core.metadata import annotate
...
from earthkit.data.utils import download_and_cache
...
class Dataset(Base):
    ...
    name = None
    """str: To be overridden by the class inheriting from Dataset.
    ...
    def __init__(self, *args, **kwargs):
        """Do nothing. To be overridden by the inheriting class."""
        pass
    ...
    def __add__(self, other):
        ...
        return from_source("multi", self.source, other.source)
    ...
    def ls(self, *args, **kwargs):
        return self.source.ls(*args, **kwargs)
...
class YamlDefinedDataset(Dataset):
    ...
    def __init__(self):
        self.source = earthkit.data.from_source(self._src, **self._args)
...
def from_dataset(name: str, *args, **kwargs) -> Dataset:
    """Loads a dataset.
