...
from emohawk.core.caching import auxiliary_cache_file, cache_file
from emohawk.core.index import (
    Index,
    MaskIndex,
    MultiIndex,
    Order,
...
from emohawk.indexing.database.sql import SqlDatabase
from emohawk.readers.grib.codes import GribField, get_messages_positions
from emohawk.readers.grib.fieldset import FieldSetMixin
from emohawk.utils import progress_bar
from emohawk.utils.parts import Part
from emohawk.utils.serialise import register_serialisation
...
class FieldSet(FieldSetMixin, Index):
    ...
    def availability(self):
        ...
        from emohawk.utils.availability import Availability
