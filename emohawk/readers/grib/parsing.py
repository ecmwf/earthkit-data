...
from emohawk.readers.grib.codes import CodesHandle
from emohawk.utils import progress_bar, tqdm
...
class GribIndexingDirectoryParserIterator(DirectoryParserIterator):
    def process_one_task(self, path):
        ...
        try:
            ...
            from emohawk.readers.grib.parsing import _index_grib_file
