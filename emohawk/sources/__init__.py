...
from emohawk.core.caching import cache_file
from emohawk.core.plugins import find_plugin
from emohawk.core.plugins import register as register_plugin
from emohawk.core.settings import SETTINGS
from emohawk.utils.html import table
...
class SourceMaker:
    def __call__(self, name, *args, **kwargs):
        ...
        #     from emohawk.mockup import SourceMockup
