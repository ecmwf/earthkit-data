...
from emohawk.readers.grib.index import FieldsetInFilesWithSqlIndex
from emohawk.readers.grib.parsing import GribIndexingDirectoryParserIterator
from emohawk.sources.indexed import IndexedSource
...
class DirectorySource(IndexedSource):
    DEFAULT_JSON_FILE = "emohawk.index"
    DEFAULT_DB_FILE = "emohawk.db"
