...
# def test_xr_datetime_1(fl_type):
...
# def test_xr_time_analysis_2():
#     ds_in = from_source("file", earthkit_examples_file("test.grib"))
#     ds = from_object(ds_in.to_xarray(time_dim_mode="valid_time", squeeze=False))

#     print(ds_in.to_xarray(time_dim_mode="valid_time", squeeze=False))
