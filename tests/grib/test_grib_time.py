...
def test_grib_time_monthly_1():
    ds = from_source("url", earthkit_remote_test_data_file("xr_engine/date/seasonal_monthly.grib")).to_fieldlist()
...
def test_grib_time_monthly_2():
    ds = from_source("url", earthkit_remote_test_data_file("xr_engine/date/ncep-seasonal-monthly.grib")).to_fieldlist()
