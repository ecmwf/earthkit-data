...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {"vertical.level": 1000, "vertical.level_type": "pressure", "parameter.variable": "t"},
            {"vertical.level": 500, "vertical.level_type": "pressure", "parameter.variable": "t"},
        ),
        (
        ...
        (
            ...
            {"vertical.level": 1000, "vertical.level_type": "pressure", "parameter.variable": "t"},
            {"vertical.level": 320, "vertical.level_type": "potential_temperature", "parameter.variable": "t"},
        ),
        (
        ...
        (
            ...
            {"vertical.level": 1000, "vertical.level_type": "pressure", "parameter.variable": "t"},
            {"vertical.level": 0, "vertical.level_type": "surface", "parameter.variable": "t"},
        ),
    ],
)
