...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "medium_cloud_layer.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [800]},
            "medium_cloud_layer",
        ),
        ("mixing_layer.grib2", {"level_dim_mode": "level", "ensure_dims": "level"}, {"level": [0]}, "mixing_layer"),
        (
            "water_surface_to_isothermal_ocean_layer.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [0]},
            "water_surface_to_isothermal_ocean_layer",
        ),
        ("entire_lake.grib2", {"level_dim_mode": "level", "ensure_dims": "level"}, {"level": [0]}, "entire_lake"),
        (
            "sea_ice_layer.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [1, 2]},
        ...
        (
            "ice_top_on_water.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [0]},
            "ice_top_on_water",
        ),
        (
            "entire_melt_pond.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [0]},
            "entire_melt_pond",
        ),
        ...
        (
            "most_unstable_parcel.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [0]},
            "most_unstable_parcel",
        ),
        (
            "snow_layer_over_ice_on_water.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [0]},
            "snow_layer_over_ice_on_water",
        ),
        ("stratosphere.grib2", {"level_dim_mode": "level", "ensure_dims": "level"}, {"level": [0]}, "stratosphere"),
        (
            "high_cloud_layer.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [450]},
            "high_cloud_layer",
        ),
        ("soil_layer.grib2", {"level_dim_mode": "level", "ensure_dims": "level"}, {"level": [1, 2]}, "soil_layer"),
        (
            "ocean_surface_to_bottom.grib2",
            {"level_dim_mode": "level", "ensure_dims": "level"},
            {"level": [0]},
