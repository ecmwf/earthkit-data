...
@pytest.mark.parametrize(
    ...
    [
        (
            {"profile": "mars", "level_dim_mode": "level", "keep_dim_role_names": False},
            {"levelist": [300, 400, 500, 700, 850, 1000]},
        ),
        (
            {"profile": "mars", "level_dim_mode": "level_and_type", "keep_dim_role_names": False},
...
@pytest.mark.parametrize(
    ...
    [
        (
            "pl.grib",
            {"profile": "grib", "level_dim_mode": "level", "keep_dim_role_names": False},
