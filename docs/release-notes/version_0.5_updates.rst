...
- changed the default :ref:`cache policy <cache_policies>` to :ref:`off <off_cache_policy>`. See the :ref:`/how-tos/misc/cache.ipynb` notebook example.
...
- enabled reading :ref:`data-sources-url` sources as streams. See the :ref:`/how-tos/source/url_stream.ipynb` notebook example
...
- added the :meth:`nearest_point_haversine` and :meth:`nearest_point_kdtree` methods to find the nearest point out of a set of locations. See the :ref:`/how-tos/grib/grib_nearest_gridpoint.ipynb` and :ref:`/how-tos/grib/grib_time_series.ipynb` notebook examples.
