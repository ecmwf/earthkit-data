...
- Improved the serialisation of GRIB fieldlists to reduce memory usage when Xarray is generated with chunks (:pr:`700`). See the :ref:`/how-tos/xr_engine/xarray_engine_chunks.ipynb` notebook example.
...
- Enabled converting :ref:`data-sources-lod` fieldlists into Xarray (:pr:`701`). See the :ref:`/how-tos/dict/list_of_dicts_to_xarray.ipynb` notebook example.
- Enabled converting Xarray generated with the earthkit engine into GRIB using :func:`to_target` (:pr:`730`). See :ref:`xr_to_grib` and the related :ref:`/how-tos/xr_engine/xarray_engine_to_grib.ipynb` notebook example.
...
- :ref:`/how-tos/xr_engine/xarray_engine_chunks.ipynb`
- :ref:`/how-tos/dict/list_of_dicts_to_xarray.ipynb`
...
- Added the :ref:`targets-zarr` target (:pr:`716`). See the :ref:`/how-tos/target/grib_to_zarr_target.ipynb` notebook example.
...
- Enabled specifying earthkit Xarray engine options via the ``earthkit_to_xarray_kwargs`` kwarg in :func:`to_target` when converting GRIB to NetCDF. See :ref:`xr_grib_to_netcdf` and related the :ref:`/how-tos/grib/grib_to_netcdf.ipynb` notebook example. (:pr:`729`) E.g.
