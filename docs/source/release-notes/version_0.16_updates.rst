...
- Allowed specifying metadata defaults for :py:meth:`~earthkit.data.indexing.xarray.XarrayMixIn.to_xarray` (:pr:`738`) via the ``fill_metadata`` option. See the notebook example :ref:`/how-tos/xr_engine/xarray_engine_mono_variable.ipynb`
