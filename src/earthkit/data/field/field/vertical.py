...
@wrap_methods(Vertical, keys=["level", "layer", "cf", "abbreviation", "units", "positive", "type"])
class VerticalFieldSpec(SimpleSpec):
    ...
    def get_grib_context(self, context) -> dict:
        from earthkit.data.specs.grib.vertical import COLLECTOR
