...
- added new sources :ref:`data-sources-wekeo` and :ref:`data-sources-wekeocds` to retrieve data from `WEkEO <https://www.wekeo.eu/>`_. See the :ref:`/examples/source/wekeo.ipynb` notebook example.
- added new source :ref:`data-sources-polytope` to retrieve data from the `Polytope web services <https://polytope-client.readthedocs.io/en/latest/>`_. See the :ref:`/examples/source/polytope.ipynb` notebook example.
