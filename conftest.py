...
# Ensure the tests/ directory is on sys.path so that pytest_plugins module
# paths (e.g. "list_of_dicts.lod_fixtures") resolve correctly from the root.
...
def pytest_configure(config):
    pytest.CDS_TIMEOUT = config.getoption("--cds-timeout", default=30)
